...
// user-preference queries (prefers-*); page-level scaffolding is the named
// exception and would be allowlisted here explicitly if it ever needs one.
// Exit 1 on any violation. Runs in `npm run lint` and CI.
